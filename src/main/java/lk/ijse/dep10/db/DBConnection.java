...
public class DBConnection {
    ...
    private DBConnection() {
        ...
        try {
            ...
            String database = configurations.getProperty("dep10.sas.db.name", "dep10_student");
            ...
            new Alert(Alert.AlertType.ERROR,"Failed to read the configurations").showAndWait();
            throw new RuntimeException(e);
        } catch (SQLException e) {
            new Alert(Alert.AlertType.ERROR,
                    "Failed to established the database connection," +
                            "try again.If the problem persist please contact the technical team").showAndWait();
            throw new RuntimeException(e);
        }
